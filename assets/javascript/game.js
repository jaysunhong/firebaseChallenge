...
$(document).ready(function () {
    ...
    function chooseStarter(starter) {
        starter.on("click", function (event) {
            ...
            if (confirmStarter) {
                // SET firebase
                database.ref('pOneStarter').set(starter.val());
                ...
                database.ref().on("value", function(snapshot) { 
                    ...
                    if (snapshot.val().pTwoStarter === 'null') {
                        $(".starterDoc").text("Waiting for your opponent...");
                    // if user picks charmander and opponent picks squirtle
                    } else if (starter.val() === "Charmander" && snapshot.val().pTwoStarter === "Squirtle") {
                    ...
                    } else if (starter.val() === "Charmander" && snapshot.val().pTwoStarter === "Pikachu") {
                        $(".starterDoc").text("Ready for battle!");
                    ...
                    } else if (starter.val() === "Charmander" && snapshot.val().pTwoStarter === "Charmander") {
                        $(".starterDoc").text("Ready for battle!");
                    ...
                    } else if (starter.val() === "Bulbasaur" && snapshot.val().pTwoStarter === "Pikachu") {
                        $(".starterDoc").text("Ready for battle!");
                    ...
                    } else if (starter.val() === "Bulbasaur" && snapshot.val().pTwoStarter === "Squirtle") {
                        $(".starterDoc").text("Ready for battle!");
                    ...
                    }  else if (starter.val() === "Bulbasaur" && snapshot.val().pTwoStarter === "Charmander") {
                        $(".starterDoc").text("Ready for battle!");
                    ...
                    }  else if (starter.val() === "Bulbasaur" && snapshot.val().pTwoStarter === "Bulbasaur") {
                        $(".starterDoc").text("Ready for battle!");
                    ...
                    } else if (starter.val() === "Squirtle" && snapshot.val().pTwoStarter === "Bulbasaur") {
                        $(".starterDoc").text("Ready for battle!");
                    ...
                    } else if (starter.val() === "Squirtle" && snapshot.val().pTwoStarter === "Charmander") {
                        $(".starterDoc").text("Ready for battle!");
                    ...
                    } else if (starter.val() === "Squirtle" && snapshot.val().pTwoStarter === "Pikachu") {
                        $(".starterDoc").text("Ready for battle!");
                    ...
                    } else if (starter.val() === "Squirtle" && snapshot.val().pTwoStarter === "Squirtle") {
                        $(".starterDoc").text("Ready for battle!");
                    ...
                    } else if (starter.val() === "Pikachu" && snapshot.val().pTwoStarter === "Squirtle") {
                        $(".starterDoc").text("Ready for battle!");
                    ...
                    } else if (starter.val() === "Pikachu" && snapshot.val().pTwoStarter === "Bulbasaur") {
                        $(".starterDoc").text("Ready for battle!");
                    ...
                    } else if (starter.val() === "Pikachu" && snapshot.val().pTwoStarter === "Charmander") {
                        $(".starterDoc").text("Ready for battle!");
                    ...
                    } else if (starter.val() === "Pikachu" && snapshot.val().pTwoStarter === "Pikachu") {
                        $(".starterDoc").text("Ready for battle!");
